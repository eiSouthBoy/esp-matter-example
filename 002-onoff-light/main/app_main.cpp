...
extern "C" void app_main()
{
    ...
    on_off_light::config_t onoff_light;
    onoff_light.on_off.on_off = DEFAULT_POWER;
    onoff_light.on_off.lighting.start_up_on_off = nullptr;

    // endpoint handles can be used to add/modify clusters.
    endpoint_t *endpoint = on_off_light::create(node, &onoff_light, ENDPOINT_FLAG_NONE, light_handle);
    ABORT_APP_ON_FAILURE(endpoint != nullptr, ESP_LOGE(TAG, "Failed to create extended color light endpoint"));

    light_endpoint_id = endpoint::get_id(endpoint);
    ESP_LOGI(TAG, "onoff light created with endpoint_id %d", light_endpoint_id);
