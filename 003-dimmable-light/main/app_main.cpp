...
extern "C" void app_main()
{
    ...
    /* Initialize driver，对灯和开关进行初始化操作 */
    ...
    // 设置 dimmable_light 配置
    dimmable_light::config_t light_config;

    light_config.on_off.on_off = powerState;
    light_config.on_off.lighting.start_up_on_off = nullptr;

    light_config.level_control.current_level = brightness;
    light_config.level_control.on_level = brightness;
    ...
    ESP_LOGI(TAG, "dimmable light created with endpoint_id %d", g_light_endpoint_id);
